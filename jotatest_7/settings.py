"""
Django settings for jotatest_7 project.
...
WSGI_APPLICATION = 'jotatest_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jotatest_7 API",
    "DESCRIPTION": "API documentation for jotatest_7 App",
    "VERSION": "v1",
}
